...
function ComboboxWithGroupsAndSeparator() {
  return (
    <div title="With Groups and Separator">
      <Combobox items={timezones}>
        <ComboboxInput placeholder="Select a timezone" />
        <ComboboxContent>
          <ComboboxEmpty>No timezones found.</ComboboxEmpty>
...
function ComboboxLargeList() {
  return (
    <div title="Large List (100 items)">
...
function ComboboxMultipleDisabled() {
  ...
  return (
    <div title="Combobox Multiple Disabled">
      <Combobox
        multiple
        autoHighlight
        items={frameworks}
...
function ComboboxMultipleInvalid() {
  ...
  return (
    <div title="Combobox Multiple Invalid">
      <div className="flex flex-col gap-4">
        <Combobox
          multiple
          autoHighlight
...
function ComboboxMultipleNoRemove() {
  ...
  return (
    <div title="Combobox Multiple (No Remove)">
      <Combobox
        multiple
        autoHighlight
        items={frameworks}
...
function ComboboxWithCustomItems() {
  return (
    <div title="With Custom Item Rendering">
      <Combobox
